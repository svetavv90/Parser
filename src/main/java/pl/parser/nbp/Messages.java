...
public final class Messages {
    ...
    final static String DATE_FROM_GT_DATE_TO = "\"Date from\" has to be earlier than date " +
            "till which you want to receive the result and available dates start from 01-01-2002";
